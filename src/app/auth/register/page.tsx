...
export const metadata: Metadata = {
  title: "Crear Cuenta - CentroMundoX",
  description: "Crea tu cuenta en CentroMundoX",
};
...
export default function RegisterPage() {
  return (
    <>
      ...
      >
        <div className="w-full max-w-lg sm:max-w-xl lg:max-w-3xl xl:max-w-4xl">
          {/* Logo y Título */}
          <div className="text-center mb-8 sm:mb-10 lg:mb-12">
            ...
            <p
              className="text-xl sm:text-2xl lg:text-3xl text-white/90 max-w-2xl mx-auto"
              style={{
