...
function DefaultErrorFallback({ error, resetError }: ErrorFallbackProps) {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl bg-white rounded-lg shadow-md p-6 sm:p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <details className="mb-4 text-left w-full">
            ...
            <pre className="mt-2 text-xs text-red-600 bg-red-50 p-2 rounded overflow-auto max-h-32 w-full">
              {error.message}
            </pre>
          </details>
          <button
